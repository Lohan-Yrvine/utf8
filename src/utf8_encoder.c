...
uint16_t utf8_enconde_two_bytes(uint16_t bytes) {
    ...
    uint16_t result = 0x0 | first_byte << 8 | second_byte;
...
uint32_t utf8_encode_three_bytes(uint32_t bytes) {
    ...
    uint32_t result = 0x0 | first_byte << 16 | second_byte << 8 | third_byte;
...
uint32_t utf8_encode_four_bytes(uint32_t bytes) {
    ...
    uint32_t result = 0x0 | first_byte << 24 | second_byte << 16 | third_byte << 8 | fourth_byte;
